        ...
        function add_floow_up()
        {
                ...
                if ($this->method == 'POST' && $user) {
                        ...
                        if ($month) {
                                ...
                                $sql = "INSERT INTO rt_floow_up(op_no, name, age, doctor_name, service_name, date_end, note, time_input) VALUE ('$op_no', '$name', $age, '$doctor_name', '$service_name', '$date_end', '$note', '$time')";
                        } else {
                                $sql = "INSERT INTO rt_floow_up(op_no, name, age, doctor_name, service_name, note, time_input) VALUE ('$op_no', '$name', $age, '$doctor_name', '$service_name', '$note', '$time')";
                        }
